...
test_that("Things work as expected", {
  ...
  expect_error(umap(data = data, n_neighbors = "Not numeric"), "n_neighbors is not a number")
  expect_error(umap(data = data, n_components = "Not numeric"), "n_components is not a number")
  ...
  expect_error(umap(data = data, n_epochs = "Not numeric"), "n_epochs is not a number")
  ...
  expect_error(umap(data = data, local_connectivity = 2.4), "local_connectivity is not a an int")
  ...
  expect_error(umap(data = data, negative_sample_rate = 2.4), "negative_sample_rate is not a an int")
  expect_error(umap(data = data, a = "Not numeric"), "a is not a numeric")
  expect_error(umap(data = data, b = "Not numeric"), "b is not a numeric")
  expect_error(umap(data = data, random_state = 2.4), "random_state is not a an int")
